...
O SGBD usado no projeto foi o Sqlite, uma vez que é o sistema gerenciador padrão implementado pelo Django e os dados armazenados pelo projeto são relacionais.
...
| Ferramentas de desenvolvimento | React (front-end), Django (back-end) e Sqlite (SGBD) |
