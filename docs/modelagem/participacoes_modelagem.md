...
| Taynara Cristina Ribeiro Marcellos | Correção planos de tempo e de custo. Elaboração do diagrama de sequência. Participação na elaboração do questionário para entrevista. Revisão do diagrama de implementação.                                                                            | -                                                                              |
